...
def newUser():
    ...
    if createLogin in users:   
        ...
        userLogin = open('userLogin.txt', 'a')
        users[createLogin] = createPassword
        userLogin.write(users + '\n')
        userLogin.close()
        print('\nUser created\n')
        print(users)
    else:
        ...
        createPassword = input('Create password: ')
        users[createLogin] = createPassword
        userLogin.write(users[createLogin:createPassword])
        print('\nUser created\n')
        print(users)
        userLogin.close()
...
# stores passwords generted by random in password.txt 
# and passwords created by users in passwordsCreated
...
#         passwordFile.close()
#         print('Your password is: %s' %(newPassword))

#     if( createP == 'n'):
#               passwordFile = open('passwordCreated.txt', 'a')
#               passw = input('Enter password: ')
#               while (len(passw) < 6):
#                      print ('Password needs to be 6 characters!')
#                      passw = input('Enter password:')
#               if(len(passw) >= 6):
#                      passwordFile2 = open('passwordCreated.txt', 'r')
#                      for passw in passwordFile2:
#                             print('Password already taken')
#                             passw = input('Enter password:')
#                      if passw != passwordFile2:
#                             passwordFile.write(passw +'\n')
