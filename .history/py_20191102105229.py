...
def numberOfTimes(n):
       ...
       return [word for word in randmWord if  len(word) == n]
       # list comprehension - setting word to equal the new word that is in the randmword txt and if that len of the word - 1 is equal 
       randmWord.close()

print(numberOfTimes(7))
